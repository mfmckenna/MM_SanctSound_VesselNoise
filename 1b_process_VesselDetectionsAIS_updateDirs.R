...
inFileOL = list.files(path=dDir, pattern = "_OL_1h.csv", full.names = TRUE, recursive = TRUE) 
inFileBB = list.files(path=dDir, pattern = "_OL_1h.csv", full.names = TRUE, recursive = TRUE) 
