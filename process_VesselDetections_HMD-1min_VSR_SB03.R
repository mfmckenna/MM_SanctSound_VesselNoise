...
for (ii in 1 : nrow(VDall) ){ # takes way too long!! not sure how to speed up?
  ...
  if ( nrow(tmp) > 0) {
    ...
    # AIS summary
    mAIS = sum(tmp$AIS)/nrow(tmp)   # minutes with AIS
...
#_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+
# SAVE R.data ####
save(outputVD,  file = paste0(outDir, "\\outputVD_" ,site1, "_", DC, ".Rda") )
...
# SAVE R.data ####
save(outputVD,  file = paste0(outDir, "\\outputVDne_" ,site1, "_", DC, ".Rda") )
